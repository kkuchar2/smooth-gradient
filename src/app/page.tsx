...
function generateGradient2(stops: number, mean: number, stddev: number): [string, number[]] {
    // 1. Calculate weights based on Gaussian curve
    let weights = [] as number[];
    for (let i = 0; i < stops; i++) {
        const x = i / stops;
...
export default function Home() {
    ...
    const [maskMean, setMaskMean] = React.useState(0);
    const [maskStdDev, setMaskStdDev] = React.useState(0.2);
    const [maskStops, setMaskStops] = React.useState(20);
                    ...
                    <div className={'flex gap-6'}>
                        <div className={'flex w-[320px] flex-col'}>
                            ...
                            <div className={'flex flex-col gap-2'}>
                                ...
                                <Slider
                                    title={`Mask standard deviation: ${maskStdDev}`}
                                    min={0}
                                    max={3}
                                    step={0.01}
                                    defaultValue={0.5}
                        ...
                        <div className={'flex flex-col gap-5'}>
                            <div style={{
                                ...
                                <div className={'rounded-3xl'} style={gradientStyle}/>
                            </div>
